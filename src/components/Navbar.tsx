        ...
        <div className="flex justify-between h-16 items-center">
          <div className="flex items-center">
            ...
            <div className="hidden md:ml-10 md:flex space-x-8">
              <Link to="/?category=Women" className="text-sm font-medium text-gray-600 hover:text-gray-900">Women</Link>
              <Link to="/?category=Men" className="text-sm font-medium text-gray-600 hover:text-gray-900">Men</Link>
              <Link to="/?category=Accessories" className="text-sm font-medium text-gray-600 hover:text-gray-900">Accessories</Link>
            </div>
          </div>
          <div className="flex items-center space-x-4 md:space-x-6">
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <div className="hidden sm:block text-sm font-medium text-gray-600">{user.displayName || user.email}</div>
